...
describe('AppComponent', () => {
    ...
    it(`should have the 'WalletWatch' title`, () => {
        const fixture = testing_1.TestBed.createComponent(app_component_1.AppComponent);
        const app = fixture.componentInstance;
        expect(app.title).toEqual('WalletWatch');
    });
    it('should render title', () => {
        ...
        expect((_a = compiled.querySelector('a')) === null || _a === void 0 ? void 0 : _a.textContent).toContain('WalletWatch');
    });
});
