...
const expenses_details_component_1 = require("./expenses-details/expenses-details.component");
...
exports.routes = [
    ...
    { path: 'expenses/:expenseId', component: expenses_details_component_1.ExpensesDetailsComponent },
    { path: 'budget', component: budget_component_1.BudgetComponent },
    // { path: 'budget/:id', component: BudgetDetailsComponent },
    { path: 'reminders', component: reminders_component_1.RemindersComponent },
    { path: 'reminders/:id', component: reminders_component_1.RemindersComponent },
...
let AppRoutingModule = (() => {
    let _classDecorators = [(0, core_1.NgModule)({
            ...
            providers: [(0, http_1.provideHttpClient)(), (0, async_1.provideAnimationsAsync)()]
        })];
